          ...
          <div className={styles.gallery}>
            {MEMORY_SCENES.map((scene) => (
              <article className={styles.sceneCard} key={scene.src}>
                ...
                >
                  <img loading="lazy" decoding="async" src={scene.src} {...responsiveImage(scene.src, "card")} alt={scene.alt} />
                </button>
