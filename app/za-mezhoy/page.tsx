...
const styles = `
  *{box-sizing:border-box}
  ...
  footer{text-align:center;padding:0 5vw 70px;color:#777168;font:12px Arial,sans-serif;letter-spacing:.05em}.rewardHint{max-width:720px;margin:0 auto 26px;color:#a79e90;font:italic 15px/1.75 Georgia,serif;letter-spacing:0}footer b{color:#b9935a;font-weight:400}footer a{display:inline-block;margin-top:14px;color:#bba67f;text-decoration:none;text-transform:uppercase;font-size:10px;letter-spacing:.14em}
