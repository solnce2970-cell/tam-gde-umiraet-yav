...
export default function BeyondPage() {
  ...
  return (
    <main className="beyondPage">
      ...
      <section className="pageFooter" aria-label="Награда за знаки Межи">
