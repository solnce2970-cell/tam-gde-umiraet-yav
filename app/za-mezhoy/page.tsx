...
const slots = [
  ...
  { id: "return-to-beginning", title: "Возвращение", text: "Последняя аномалия не лежит дальше остальных. Она ждёт в начале." },
];
  ...
  return (
    <main className="beyondPage">
      ...
      <section className="hero">
        ...
        <div className="progress"><span>Аномалии</span><b>{count} / 13</b></div>
      </section>

      <section className="memoryGrid" aria-label="Найденные аномалии">
      ...
      <section className={`excerpt ${count >= 13 ? "open" : "locked"}`}>
        <p className="eyebrow">Награда за 13 аномалий</p>
        ...
        {count >= 13 ? (
          ...
          <p>Он откроется только после того, как будут найдены все тринадцать аномалий.</p>
        )}
      </section>
...
const styles = `
  *{box-sizing:border-box}
  ...
  .hero{max-width:1100px;margin:0 auto;padding:90px 6vw 56px;text-align:center}.eyebrow{margin:0 0 12px;color:#b9935a;font:11px/1.3 Arial,sans-serif;letter-spacing:.2em;text-transform:uppercase}.hero h1{font-size:clamp(58px,10vw,128px);font-weight:400;line-height:.9;margin:0 0 28px;letter-spacing:-.04em}.hero>p:last-of-type{max-width:650px;margin:0 auto;color:#9e978b;line-height:1.8;font-size:16px}.progress{display:flex;justify-content:center;gap:14px;align-items:baseline;margin-top:34px;font-family:Arial,sans-serif;text-transform:uppercase;letter-spacing:.14em;color:#817b70;font-size:10px}.progress b{color:#d5c09a;font-size:18px;font-weight:400}
  ...
  @media(max-width:620px){.topbar{padding:16px 18px}.topbar a:first-child{font-size:11px}.hero{padding-top:64px}.memoryGrid{grid-template-columns:1fr;padding:0 14px 70px}.memoryCard{min-height:205px}.excerpt{margin-bottom:64px}}
`;
